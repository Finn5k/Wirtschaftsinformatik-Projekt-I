...
| Verwendung | Abgleich der Frontend-Dokumentation mit den vorhandenen Routen, Seiten, Komponenten, Mockdaten und Services. |
| Prüfung | Angaben wurden gegen `src/` und die Bausteine B1, F2, F3, D1, D2, S1 und N1 geprüft; ein realer Reverse-Geocoding-Aufruf wurde im Browser getestet. Diese Dokumentation ergänzt keine fachlichen oder technischen Entscheidungen. |
