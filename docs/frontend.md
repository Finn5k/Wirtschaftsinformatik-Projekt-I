...
|---|---|---|
| DLG-01 Anmelden / Registrieren | `/login` | Umschaltung zwischen Anmeldung und Registrierung, E-Mail-/Passwortfelder, Anzeigename bei Registrierung, clientseitige Validierung, Link „Zurück zu Entdecken" zur öffentlichen Sicht (DLG-02); Anmeldung, Registrierung und Abmeldung über NB-02, Sitzung übersteht einen Reload |
...
| DLG-05 Session erstellen | `/sessions/new` | Sportart, Titel, Beschreibung, Datum und Uhrzeit mit Bedienhinweisen bei leerem Feld, Dauerbedienung in 15-Minuten-Schritten bei Mindestwert 1, Court-Auswahl oder Neuerfassung per Kartenpin, Teilnehmerlimit, Validierung; Anlage über `create_session` samt Court und Organisator-Teilnahme, danach Wechsel zur Detailansicht |
