...
| **Tester** | Prüfbare Akzeptanzkriterien und Qualitätsanforderungen je Use Case; Grundlage für Testfälle. | [F2](F2-anwendungsfaelle.md) (Akzeptanzkriterien), [F3](F3-anwendungsfunktionen.md) (Algorithmen), [N1](N1-nichtfunktionale-anforderungen.md) |
...
| **Tester** | [F2](F2-anwendungsfaelle.md) (Akzeptanzkriterien) → [F3](F3-anwendungsfunktionen.md) (Algorithmen) → [N1](N1-nichtfunktionale-anforderungen.md) | Akzeptanzkriterien je Use Case sind die Grundlage funktionaler Tests; die Algorithmen in F3 decken die Randfälle ab; N1 liefert die nichtfunktionalen Prüfkriterien. |
...
| **Professor / Prüfer** | [README](README.md) → E1 (dieser Baustein) → [P1](P1-ziele-rahmenbedingungen.md) → [P2](P2-architekturueberblick.md) → [F1](F1-geschaeftsprozesse.md) → [F2](F2-anwendungsfaelle.md) → [F3](F3-anwendungsfunktionen.md) → [D1](D1-datenmodell.md) → [D2](D2-datentypen.md) → [B1](B1-dialogspezifikation.md) → [S1](S1-nachbarsysteme.md) → [S3](S3-inbetriebnahme.md) → [N1](N1-nichtfunktionale-anforderungen.md) → [N2](N2-querschnittskonzepte.md) → [E2](E2-glossar.md) | Vollständiger Durchlauf durch alle anwendbaren Bausteine in Siedersleben-Reihenfolge; E1 vorab erklärt Struktur und ID-Schema, damit die anschließende Prüfung auf Vollständigkeit und Konsistenz zielgerichtet erfolgen kann. |
...
| **S — Schnittstellen und Inbetriebnahme** | Mit welchen Nachbarsystemen kommuniziert LocalCourt, über welche Operationen und mit welcher Fehlersemantik, und was gilt für seine Inbetriebnahme? | [S1](S1-nachbarsysteme.md) Nachbarsysteme, [S3](S3-inbetriebnahme.md) Inbetriebnahme; S2 Datenmigration ist nicht anwendbar (siehe [E1.8](#e18-umgang-mit-offenen-und-nicht-anwendbaren-bausteinen)) |
...
Ein fehlender Eintrag im Index wäre also ein Fehler, keine bewusste Auslassung: Jeder Baustein trägt einen im Spezifikationsindex begründeten Status. Die Tabelle oben übernimmt diesen Status nur zur Orientierung; maßgeblich bleibt ausschließlich der [Spezifikationsindex](README.md#bausteine-der-spezifikation) (siehe [E1.9](#e19-konsistenzregeln)).
