...
| **Fehlerbehandlung** | Technische Fehler (fehlendes oder abgelaufenes Token, verletzte Zugriffsregel, Datenbankfehler) werden nach [N2.3](N2-querschnittskonzepte.md#n23-fehler-mapping-ergebniscodes--http) beantwortet und als Fehlerzustand nach [B1.5.4](B1-dialogspezifikation.md#b154-fehler--und-ladezustände) angezeigt. Meldungen an den Nutzer enthalten keine technischen Interna ([B1.5.4](B1-dialogspezifikation.md#b154-fehler--und-ladezustände)). |
...
| **Mengen und Grenzen** | Die Nutzung bleibt im Rahmen des Free-Tiers ([P1](P1-ziele-rahmenbedingungen.md) CON-T-02, [Architekturdokumentation §6](../arch/README.md#6-verteilung-und-deployment)). Ergebnislisten werden seitenweise abgerufen; die konkrete Seitengröße ist ein Umsetzungsdetail. |
...
| [N1](N1-nichtfunktionale-anforderungen.md) | N1-QA-01 fordert die hier beschriebenen Ausfallpfade, N1-QA-03 begrenzt die übertragenen personenbezogenen Daten und die Behandlung von Schlüsseln. |
