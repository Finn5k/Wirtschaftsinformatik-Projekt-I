...
| Festlegung | Das Verhalten bei gleichzeitigem Beitritt ist in [F3 AF-01](F3-anwendungsfunktionen.md#af-01--beitritts--und-kapazitätsregel) fachlich präzisiert (wer zuerst kommt, keine Überbuchung) und in [S1.4](S1-nachbarsysteme.md#s14-nb-03--supabase-postgrest) als atomare Operation `join_session` umgesetzt. |
...
| Verwendung | Entwurf und Strukturierung der Use Cases UC-01–UC-12, Formulierung prüfbarer Akzeptanzkriterien sowie Erstellung der PlantUML-Diagramme (`diagrams/F2-use-cases.puml`, `diagrams/F2-uc10-court-erfassen.puml`). |
| Prüfung | Abgeglichen mit [P1](P1-ziele-rahmenbedingungen.md), [P2](P2-architekturueberblick.md), [F1](F1-geschaeftsprozesse.md), [F3](F3-anwendungsfunktionen.md), [D1](D1-datenmodell.md), [D2](D2-datentypen.md), [B1](B1-dialogspezifikation.md), [S1](S1-nachbarsysteme.md) und [N1](N1-nichtfunktionale-anforderungen.md); die Diagramme wurden gegen F1 geprüft und im Layout manuell nachbearbeitet. |
