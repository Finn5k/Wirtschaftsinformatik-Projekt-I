...
| Akzeptanzkriterien | **Given** einen nicht angemeldeten Nutzer,<br>**When** er eine geschützte Aktion auslöst,<br>**Then** wird er zu DLG-01 geleitet und die Aktion wird nicht ausgeführt.<br><br>**Given** eine Teilnehmerliste,<br>**When** sie angezeigt wird,<br>**Then** erscheinen ausschließlich Anzeigename und optionales Profilbild.<br><br>**Given** den Teilnehmer-Zustand von DLG-04,<br>**When** ein Nutzer die Session öffnet,<br>**Then** ist die PIN nicht sichtbar. |
