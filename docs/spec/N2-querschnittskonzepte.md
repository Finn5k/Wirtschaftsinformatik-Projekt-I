...
Nicht mehr hier geführt, weil andernorts entschieden: Feldlängen, maximale Session-Dauer und Check-in-Zeittoleranz sind in [N1.7](N1-nichtfunktionale-anforderungen.md#n17-bewusst-nicht-festgelegte-qualitätsanforderungen) als bewusst nicht festgelegt dokumentiert. Die sichtbaren Profilfelder sind in [D1.4](D1-datenmodell.md#d14-entitätstypen-im-detail) und [B1 DLG-04](B1-dialogspezifikation.md#b144-dlg-04--session-detail) festgelegt und technisch in [N2.11](#n211-row-level-security-rls) freigegeben. Court-Dubletten bleiben eine Frage des Dialogverhaltens in [B1.8](B1-dialogspezifikation.md#b18-offene-punkte).
...
| Verwendung | Entwurf des N2-Bausteins: Auflösung der in D1, D2 und F3 explizit an N2 verwiesenen offenen Punkte (Typzuordnung, Schlüssel/Constraints, Atomarität des Beitritts, Statuspersistenz, PIN-Speicherung, QR-Inhalt, Identifier-Strategie, RLS, Fehler-Mapping) auf Basis des bestehenden Tech-Stacks (P1 CON-T-01–CON-T-03, P2). Codex entfernte am 2026-07-29 das nicht zum MVP gehörende `is_cancelled`-Feld, glich die Check-in-Zeittoleranz an N1 an, ergänzte die atomare Court-Erfassung nach erfolgreichem Reverse-Geocoding und bereinigte den veralteten Offenpunkt zur Profilsichtbarkeit. |
